...
const audioArray = [
  "Lös_uppgiften.mp3",
  "Har_du_gjort_övningsprovet.mp3",
  "Har_du_ens_öppnat_gleerups.mp3",
  "Minst_två_uppgifter_ska_du_göra.mp3",
  "Du_lyssnar_ju_aldrig.mp3",
];
...
// function playSound() {
//   let audio = new Audio('sound.mp3'); // Replace with your file path
//   audio.play();
// }
